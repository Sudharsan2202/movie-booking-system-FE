    ...
    bg-[url("/backgroundImage.png")] bg-cover bg-center h-screen'>
        ...
        <h1 className='text-5xl md:text-[70px] md:leading-18 font-semibold max-w-110'>
             ...
             <p className='max-w-md text-gray-300'>
                In a post-apocalyptic worid where cities ride on wheels on and consume each oyher to survive, 
                two people meet in London and try to stop a conspiracy.
             </p>

             <button 
      onClick={() => navigate('/movies')} 
      className='flex items-center gap-1 px-6 py-3 text-sm bg-red-500
