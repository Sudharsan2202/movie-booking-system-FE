          ...
          {dashboardCards.map((card, index) => (
            <div
              ...
              className="flex items-center justify-between px-4 py-3 
                         ...
                         max-w-50 w-full md:w-[calc(50%-0.5rem)] lg:w-[calc(25%-0.75rem)]"
            >
              <div>
...
<div className="relative flex flex-wrap gap-6 mt-4 max-w-5x1"> 
    ...
    <div key ={show. id} className="w-55 rounded-lg overflow-hidden h-full pb-3 
    bg-red-500/10 border border-red-500/20 hover:-translate-y-1 transition duration-300">
        <img src={show.movie.poster_path} alt="" className="h-60 w-full object-cover" />
        <p className="font-medium p-2 truncate">{show.movie.title}</p>
        <div className="flex ites-center justify-between px-2">
            <p className="text-ig font-medium">{currency} {show.showPrice}</p>
